...
const QUOTES = [
  { t: "If you do not know to which port you are sailing, no wind is favorable.", a: "Seneca", e: "Without a clear purpose, every circumstance becomes equally irrelevant. Direction comes before effort." },
  { t: "Love of bustle is not industry.", a: "Seneca", e: "Motion isn't progress. Being perpetually busy can be its own form of avoidance — of the harder, quieter work that actually matters." },
  { t: "It is not that life is short, but that we waste much of it.", a: "Seneca", e: "The opening argument of On the Shortness of Life. Time isn't scarce — our attention is. Most of what feels like living isn't." },
  { t: "Be strict with yourself and tolerant with others.", a: "Marcus Aurelius", e: "Hold your own conduct to the highest standard you can manage, while extending the same patience to others that you'd want extended to you." },
  { t: "Think of the things you have, and how eagerly you would want them if you did not have them.", a: "Marcus Aurelius", e: "A gratitude exercise in reverse: don't imagine acquiring what you lack — imagine losing what you already have. The want returns immediately." },
  { t: "Persist and resist.", a: "Epictetus", e: "Two words that cover most of the practice: keep going when it's hard, and hold the line when temptation or distraction arrives." },
  { t: "They did not offend me; I took offense.", a: "after Epictetus", e: "The event and your reaction to it are separate things. The offense lives in your interpretation — which is the one thing you can actually do something about." },
  { t: "Receive without pride, let go without attachment.", a: "Marcus Aurelius", e: "Good fortune doesn't make you better; bad fortune doesn't make you worse. Hold both lightly — receive what comes, release what goes." },
  { t: "You could leave life right now. Let that determine what you do and say and think.", a: "Marcus Aurelius", e: "A memento mori in its most direct form. If this were the last conversation, the last task, the last hour — what would actually matter?" },
  { t: "No role is so well suited to philosophy as the one you happen to be in right now.", a: "Marcus Aurelius", e: "The practice doesn't require different circumstances. It requires engaging more honestly with the ones you're already in. Now is always the right time." },
  { t: "The impediment to action advances action. What stands in the way becomes the way.", a: "Marcus Aurelius", e: "The obstacle isn't a detour from the work — it is the work. What frustrates you is also showing you exactly where to direct your effort." },
  { t: "Well-being is attained by little and little, and nevertheless is no little thing itself.", a: "Zeno", e: "The founder of Stoicism on the paradox of small disciplines: each individual act seems trivial, but the accumulated pattern is what a life is made of." },
  { t: "Wealth consists not in having great possessions, but in having few wants.", a: "Epictetus", e: "You can get richer two ways: acquire more, or want less. The second is entirely within your control; the first never fully is." },
  { t: "It is not the man who has too little, but the man who craves more, that is poor.", a: "Seneca", e: "Poverty is a condition of desire, not of circumstance. The wealthiest person is still poor if what they have is never enough." },
  { t: "If you don't regard what you have as enough, you will never be happy even if you rule the entire world.", a: "Seneca", e: "The satisfaction that comes from acquisition is temporary by design — the next want arrives before the last one has settled. Enough is a decision, not a threshold." },
  { t: "First say to yourself what you would be; and then do what you have to do.", a: "Epictetus", e: "Identity precedes action. Decide what kind of person you're trying to become, then let that decision make the smaller choices obvious." },
  { t: "Our plans miscarry because they have no aim.", a: "Seneca", e: "Plans fail not from poor execution but from vague purpose. Know specifically what you're aiming at before you start moving." },
  { t: "Don't let your imagination be crushed by life as a whole. Stick with the situation at hand.", a: "Marcus Aurelius", e: "Zooming out to the full weight of everything wrong is a reliable way to be paralysed. The only workable unit is the one thing in front of you right now." },
  { t: "Ask yourself at every moment, 'Is this necessary?'", a: "Marcus Aurelius", e: "A simple audit Marcus applied to his own speech, actions, and thoughts. Most of what fills a day doesn't survive the question." },
  { t: "We suffer more from imagination than from reality.", a: "Seneca", e: "Most suffering is pre-emptive — the imagined event is almost always worse than the experienced one. The mind adds weight that reality rarely delivers." },
  { t: "You have power over your mind — not outside events. Realize this, and you will find strength.", a: "Marcus Aurelius", e: "The foundation of Stoic practice in one line. Everything outside your mind is outside your control; everything inside it is, in principle, yours to shape." },
  { t: "Waste no more time arguing about what a good man should be. Be one.", a: "Marcus Aurelius", e: "Philosophy as action, not debate. The conversation about virtue is useful only insofar as it produces virtuous behaviour. At some point, discussion has to stop." },
  { t: "The best revenge is to be unlike him who performed the injury.", a: "Marcus Aurelius", e: "Responding to poor behaviour by mirroring it gives the other person a second victory. The only worthwhile response is to remain yourself." },
  { t: "The soul becomes dyed with the color of its thoughts.", a: "Marcus Aurelius", e: "What you dwell on persistently — grievance, ambition, gratitude, envy — isn't just a passing mood. It gradually becomes the texture of who you are." },
  { t: "Sometimes even to live is an act of courage.", a: "Seneca", e: "Courage isn't only visible in dramatic moments. Showing up fully — in grief, in illness, in ordinary difficulty — is its own form of bravery." },
  { t: "Fire tests gold, suffering tests brave men.", a: "Seneca", e: "Adversity isn't something to be merely survived. It's the condition under which character is actually revealed — and built." },
  { t: "As long as you live, keep learning how to live.", a: "Seneca", e: "The practice doesn't complete. Each stage of life brings new conditions that require new understanding. Stopping the inquiry is the only real failure." },
  { t: "No man is free who is not master of himself.", a: "Epictetus", e: "External freedom — political, financial, social — is hollow if you're still controlled by appetite, fear, or the need for approval. Self-mastery is the only real freedom." },
  { t: "Men are disturbed not by things, but by the view which they take of them.", a: "Epictetus", e: "The founding principle of cognitive therapy, two thousand years early. Events are neutral; your interpretation of them is where suffering — or equanimity — is created." },
  { t: "We have two ears and one mouth so that we can listen twice as much as we speak.", a: "Epictetus", e: "Most of what you'd gain from a conversation comes from the other person, not from yourself. Talking more doesn't mean learning more." },
  { t: "In things relating to the body, take only as much as your bare need requires.", a: "Epictetus", e: "Temperance in physical life: food, sleep, comfort. Taking exactly what's needed — not less as deprivation, not more as indulgence — is its own discipline." },
  { t: "All the good are friends of one another.", a: "Zeno", e: "Virtue creates kinship across time, distance, and circumstance. Anyone genuinely trying to live well is, in a meaningful sense, your ally." },
  { t: "No loss should be more regrettable to us than losing our time, for it's irretrievable.", a: "Zeno", e: "Money lost can be recovered. Reputation rebuilt. Time lost is gone without exception — which makes how you spend it the most consequential choice you make." },
  { t: "Only in good actions is there true joy.", a: "Musonius Rufus", e: "Joy that depends on external conditions is always conditional. The only joy that holds regardless of what happens is the joy of having acted well." },
  { t: "Life is long, if only you knew how to use it.", a: "Seneca", e: "The opening line of On the Shortness of Life. The problem isn't that we get too little time — it's that we squander most of what we're given." },
  { t: "He who is brave is free.", a: "Seneca", e: "Not freedom as independence from others, but inner freedom — from fear, from craving approval, from the tyranny of wanting what you can't control." },
  { t: "Practice even what seems impossible.", a: "Marcus Aurelius", e: "The standard isn't what's currently within reach. It's what virtue requires — whether or not it feels attainable today." },
  { t: "They lose the day in waiting for the night, and the night in fearing the dawn.", a: "Seneca", e: "A portrait of the anxious life: always somewhere other than the present moment, dreading what's coming or counting down to escape." },
  { t: "It isn't ceasing to live that I'm afraid of but never beginning to live properly.", a: "Marcus Aurelius", e: "Not death that should concern you — but the possibility of reaching it without having actually started." },
  { t: "The things you think about determine the quality of your mind.", a: "Marcus Aurelius", e: "A companion to 'the soul becomes dyed with the colour of its thoughts.' What you dwell on, you become. Your mental diet matters as much as your physical one." },
  { t: "Lay hold of today's task, and you will not need to depend so much upon tomorrow's.", a: "Seneca", e: "Do the day's work today. Procrastination doesn't save effort — it stores it up with interest." },
  { t: "If you want to improve, you must be content to be thought foolish and stupid.", a: "Epictetus", e: "The beginner's condition is unavoidable. Caring more about how you look while learning than about actually learning is what keeps most people from ever improving." },
  { t: "Where you arrive does not matter as much as what sort of person you are when you arrive there.", a: "Seneca", e: "The destination — the job, the city, the relationship — matters less than the character you bring to it. You carry your interior life everywhere." },
  { t: "Freedom is the only worthy goal in life. It is won by disregarding things that lie beyond our control.", a: "Epictetus", e: "Not freedom as independence from others, but as independence from your own unruly desires and fears. The dichotomy of control, stated as a single life objective." },
  { t: "The art of living is more like wrestling than dancing, in so far as it stands ready against the accidental and the unforeseen.", a: "Marcus Aurelius", e: "Life doesn't choreograph itself in advance. The practice is less about elegant routine and more about being ready to meet whatever actually arrives." },
];
